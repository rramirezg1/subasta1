...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <!-- Top Menu Items -->
            <?php
              //Se incluye el archivo que contiene el header "cerrar y editar datos"
              include ("header1.php");
            ?>
            <!-- Sidebar Menu Items - These collapse to the responsive navigation menu on small screens -->
            <?php
              //Se incluye el archivo que contiene el sidebar ""menu vertical"
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                /*  $res_count=$bd->select("SELECT count(*) as total from cesta where id_usuario=".$_SESSION["id_usuario"]);
                  ...
                  $res_count=$bd->select("SELECT count(*) as total from subasta where estado=0 and usuario_idusuario=".$_SESSION["id_usuario"]);
                  $data=mysqli_fetch_array($res_count);
                  $count_sub_act = $data['total'];//En esta variable se guardan el total

                  //Count para las subastas propias cerradas
                  $res_count=$bd->select("SELECT count(*) as total from subasta where estado=1 and usuario_idusuario=".$_SESSION["id_usuario"]);
                  $data=mysqli_fetch_array($res_count);
