  ...
  <?php
    ...
    if(isset($_POST["agregar"])){
      ...
      if($foto == null){
        ...
        $res = $bd->query("INSERT into producto(nombre, descripcion, imagen, categoria_id_categoria)
        ...
        if($res==true){
          ...
          $res2 = $bd->query("INSERT into subasta(min, max, tiempo_ini, tiempo_fin, estado, usuario_idusuario, producto_idproducto)
