            ...
            <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <?php
                      ...
                      //creacion de cuenta de producto a subastar
                      ...
                      if($res->num_rows > 0){
                        while($row = $res->fetch_assoc()){
                          ...
                          //codigo q me muesra nombre e imagen del producto subastado
                          ...
                          if($res2->num_rows > 0){
                            while($row2 = $res2->fetch_assoc()){
                              ...
                              /*codigo donde me tra el valor o oferta q hice un comprador y me muestra
                              debajo del imagen del producto en subasta*/
                              $res3 = $bd->select("SELECT * from oferta where  subasta_id_subasta=$id_subasta order by id_oferta desc limit 1");
                              if($res3->num_rows > 0){
