            ...
            <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <?php
                          ...
                          //Inicia consulta de subastas o subastas activas
                          $iduser = $_SESSION['id_usuario'];
                          $res = $bd->select("SELECT * from subasta where comprador=$iduser and estado=0 order by id_subasta desc");
                          if($res->num_rows > 0){
                            while($row = $res->fetch_assoc()){
                              ...
                              if($res2->num_rows > 0){
                                while($row2 = $res2->fetch_assoc()){
                                  ...
                                  $catego_p = $row2["categoria_id_categoria"];
                                  ...
                                  //Inicia consulta de oferta del producto
                                  $result1 = $bd->select("SELECT * from oferta where subasta_id_subasta=$sub order by id_oferta desc limit 1");
                ...
                <!-- Inicia subastas mias que ya fueron vendidas -->
                  ...
                  <?php
                          ...
                          //Inicia consulta de subastas o subastas cerradas
                          $iduser = $_SESSION['id_usuario'];
                          $res = $bd->select("SELECT * from subasta where usuario_idusuario=$iduser and estado=1 order by id_subasta desc");
                          if($res->num_rows > 0){
                            while($row = $res->fetch_assoc()){
                              $sub = $row["id_subasta"];
                              $min = $row["min"];
